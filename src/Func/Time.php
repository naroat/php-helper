...
if (! function_exists('week_interval_by_year_month')) {
    /**
     * @param string $year_month
     * @param string $format
     * @return array
     */
    function week_interval_by_year_month($year_month = '', $format = 'Y-m-d')
    {
...
if (! function_exists('get_the_month')) {
    /**
     * //获取具体日期的函数.
     * @param $date
     * @return array
...
if (! function_exists('get_date_by_interval')) {
     ...
     * @return array
     */
    function get_date_by_interval($startDate, $endDate, $type)
    {
...
if (! function_exists('mFristAndLast')) {
     ...
     */
    function frist_last_by_month($y = "2021", $m = ""){
        if ($y == "") $y = date("Y");
        if ($m == "") $m = date("m");
